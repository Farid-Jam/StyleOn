...
const featured = [
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/1040945/pexels-photo-1040945.jpeg?auto=compress&cs=tinysrgb&w=700',
    size: 'large',
  },
  {
    title: 'TROUSERS',
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/1082529/pexels-photo-1082529.jpeg?auto=compress&cs=tinysrgb&w=700',
    size: 'medium',
  },
];
...
export default function CollectionsSection() {
  return (
    <section style={{ backgroundColor: '#b7b7a4' }} className="py-24 px-8 md:px-16">
      <div className="flex items-end justify-between mb-14">
        <div>
          <span className="block text-xs tracking-[0.35em] uppercase mb-3" style={{ color: '#ffe8d6', opacity: 0.7, letterSpacing: '0.3em' }}>
            Shop by Category
          </span>
          <h2 className="font-light leading-tight" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)', color: '#ffe8d6', fontFamily: "'Georgia', serif" }}>
            The Collections
          </h2>
        </div>
        <a href="#" className="hidden md:flex items-center gap-1 text-xs tracking-widest uppercase" style={{ color: '#ffe8d6', opacity: 0.75, letterSpacing: '0.15em' }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div
          ...
          style={{ height: '520px', borderRadius: '3px' }}
        >
          <img
          ...
          <div className="absolute bottom-8 left-8 right-8">
            ...
            <button
              className="mt-5 flex items-center gap-2 px-6 py-3 text-xs tracking-widest uppercase transition-all duration-200"
              style={{ border: '1px solid rgba(255,232,214,0.5)', color: '#ffe8d6', borderRadius: '2px', letterSpacing: '0.15em' }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'rgba(255,232,214,0.15)'; }}
        ...
        <div
          className="flex flex-col justify-between p-8 cursor-pointer group transition-all duration-300"
          style={{ height: '280px', borderRadius: '3px', backgroundColor: '#6b705c' }}
          onMouseEnter={(e) => ((e.currentTarget as HTMLDivElement).style.backgroundColor = '#cb997e')}
          onMouseLeave={(e) => ((e.currentTarget as HTMLDivElement).style.backgroundColor = '#6b705c')}
        >
          <p
